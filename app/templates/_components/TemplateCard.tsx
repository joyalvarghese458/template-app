    ...
    <article className="group relative flex flex-col bg-canvas-bg rounded-2xl overflow-hidden border border-ink/10 hover:border-brand/40 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_50px_-12px_rgba(37,99,235,0.18)]">
      ...
      <div className="flex flex-col gap-3 p-4 sm:p-5">
        <div className="min-h-[3.5rem]">
          <h3 className="font-serif text-lg sm:text-xl text-ink tracking-tight leading-tight">
            {template.title}
          </h3>
          <p className="text-xs sm:text-[13px] text-ink-soft mt-1 line-clamp-1">
            {template.tag}
          </p>
        </div>
        ...
        <div className="flex items-baseline justify-between">
          <span className="text-ink">
            <span className="text-[11px] font-semibold text-ink-soft mr-1">AED</span>
            <span className="font-serif text-2xl tabular-nums">{tier.price}</span>
          </span>
        ...
        <div className="flex gap-1.5 mt-1">
          <Link
            href={templateHref(template)}
            className="flex-1 inline-flex items-center justify-center gap-1 px-2 py-2 text-xs font-bold text-brand bg-canvas-bg border border-brand/40 hover:bg-brand/10 rounded-lg transition-all duration-200 active:scale-95"
          >
          ...
          <a
            ...
            className="flex-1 inline-flex items-center justify-center gap-1 px-2 py-2 text-xs font-bold text-canvas-bg bg-brand hover:bg-brand/90 rounded-lg shadow-lg shadow-brand/30 transition-all duration-200 active:scale-95"
          >
            <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
