      ...
      <div className={styles.footerInner} ref={ref}>
        ...
        <div className={styles.bottom}>
          ...
          <div className={styles.socials}>
            <a className={styles.socialLink} href="https://www.facebook.com/purestudio" aria-label="Facebook">
            ...
            <a className={styles.socialLink} href="https://x.com/purestudio" aria-label="Twitter">
            ...
            <a className={styles.socialLink} href="https://www.instagram.com/purestudio/" aria-label="Instagram">
            ...
            <a className={styles.socialLink} href="https://dribbble.com/purestudio" aria-label="Dribbble">
