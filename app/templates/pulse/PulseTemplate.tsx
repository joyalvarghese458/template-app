  ...
  return (
    <main className={`${styles.page} min-h-screen ${styles.shell}`}>
      <div className="mx-auto max-w-[1280px] px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-10">
        <div
          className={`${styles.heroCard} overflow-hidden rounded-[34px] shadow-[0_30px_90px_rgba(8,12,24,0.22)]`}
        >
          <div className="grid lg:grid-cols-[320px_minmax(0,1fr)]">
            <aside
              className={`${styles.sidebar} flex flex-col gap-7 px-6 py-8 sm:px-8 sm:py-10 lg:py-12`}
            >
              <div>
            ...
            <div className="min-w-0 space-y-8 bg-white px-5 py-8 sm:px-8 md:space-y-10 md:py-10 lg:px-10 lg:py-12">
              <div className={styles.contentBlock}>
