            ...
            <div className={styles.heroVisual}>
              ...
              <div className={styles.heroFloatCard}>
                ...
                <div>
                  ...
                  <div className={styles.heroFloatSub}>
                    Brand · Type · Motion
                  </div>
                </div>
              </div>
        ...
        <div className={styles.container}>
          ...
          >
            ...
            <h2 className={styles.sectionTitle}>
              Selected{" "}
              <em className={styles.accent}>Projects</em>
            </h2>
            <p className={styles.sectionLead}>
              A curated look at brand identity, editorial, and campaign work
              from 2023–2026.
            </p>
          </div>
          ...
          >
            ...
            <div className={styles.aboutContent}>
              ...
              <h2 className={styles.sectionTitle}>
                The person behind
                <br />
                the <em className={styles.accent}>pixels</em>
              </h2>
          ...
          >
            ...
            <div className={styles.resumeContent}>
              ...
              <p className={styles.resumeDesc}>
                8 years of work history, education, awards, and client
                references — all in one clean PDF.
              </p>
              <a
            ...
            <div className={styles.resumeVisual} aria-hidden="true">
              <div className={styles.resumeDoc}>
                ...
                <div
                  className={styles.resumeDocLine}
          ...
          >
            <div className={styles.contactInfo}>
              ...
              <h2 className={styles.sectionTitle}>
                Let&apos;s create
                <br />
                something <em className={styles.accent}>great</em>
              </h2>
                ...
                >
                  <div className={styles.formRow}>
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel} htmlFor="solo-name">
                        Name
                      </label>
                      <input
                        id="solo-name"
                    ...
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel} htmlFor="solo-email">
                        Email
                      </label>
                      <input
                        id="solo-email"
                  ...
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel} htmlFor="solo-project">
                      Project type
                    </label>
                    <input
                      id="solo-project"
                      type="text"
                      className={styles.formInput}
                      placeholder="Brand identity, packaging, editorial…"
                    />
                  </div>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel} htmlFor="solo-message">
                      Message
                    </label>
                    <textarea
                      id="solo-message"
        ...
        <div className={styles.container}>
          <div className={styles.footerInner}>
            ...
            <div className={styles.footerSocials}>
              <a href={PROFILE.instagram} className={styles.footerSocialLink}>
                IG
              </a>
              <a href={PROFILE.behance} className={styles.footerSocialLink}>
                BE
              </a>
              <a href={PROFILE.linkedin} className={styles.footerSocialLink}>
                LI
              </a>
              <a href={PROFILE.dribbble} className={styles.footerSocialLink}>
                DR
              </a>
            </div>
          </div>
