...
function TierCarousel({ tier }: { tier: TierWithTemplates }) {
  ...
  return (
    <div>
      ...
      <div
        ref={scrollerRef}
        className="flex gap-8 sm:gap-7 overflow-x-auto overflow-y-hidden snap-x snap-mandatory pb-6 -mx-4 pl-8 pr-6 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
      >
